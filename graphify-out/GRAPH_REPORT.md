...
## Corpus Check
- 75 files · ~44,302 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 346 nodes · 437 edges · 39 communities (28 shown, 11 thin omitted)
...
Cohesion: 0.10
Nodes (22): FormState, ContactController, ContactControllerInterface, ContactModel, SendContactRequest, SendContactResponse, ResendContactRepository, CustomAxiosRequestConfig (+14 more)
...
Cohesion: 0.18
Nodes (9): clerk-authentication, Flujos de Trabajo, graphify, This is NOT the Next.js you know, Implement Feature, Notas operativas, Ruta Completa, Ruta de Corrección (+1 more)
...
## Knowledge Gaps
- **183 isolated node(s):** `resend`, `inter`, `metadata`, `HighlightItem`, `HIGHLIGHTS` (+178 more)
...
- **Why does `ScrollReveal()` connect `devDependencies` to `page.tsx`?**
